...
Can Has? is a really really simple Rails plugins that adds a DSL for checking a users permissions on a model. It allows you to write something like this:
